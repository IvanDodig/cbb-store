...
const ProductsList = () => {
   ...
   const columns = [
      { dataField: "productId", text: "#", sort: true },
      {
         dataField: "productName",
         text: "Name",
         sort: true,
      },
      { dataField: "listPrice", text: "Price", sort: true },
      {
         dataField: "modelYear",
         text: "Year",
         sort: true,
      ...
      },
      {
         ...
         events: {
            onClick: (e, column, columnIndex, row, rowIndex) => {
               history.push("/products/update/" + row.productId);
            },
         },
      },
      {
   ...
   useEffect(() => {
      ...
      brandServices.getBrands().then((res) => {
         if (res.status === 200) {
            setBrands(
               res.data.map((brand) => {
